...
namespace Unilever.CDExcellent.API.Migrations
{
    ...
    [Migration("20250214050710_AddCreatedAtToUser")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Unilever.CDExcellent.API.Models.Entities.Article", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Unilever.CDExcellent.API.Models.Entities.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Unilever.CDExcellent.API.Models.Entities.OtpCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Unilever.CDExcellent.API.Models.Entities.Article", b =>
                {
                    b.HasOne("Unilever.CDExcellent.API.Models.Entities.User", "Author")
                        .WithMany("Articles")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Unilever.CDExcellent.API.Models.Entities.Category", "Category")
                        .WithMany("Articles")
            ...
            modelBuilder.Entity("Unilever.CDExcellent.API.Models.Entities.Comment", b =>
                {
                    b.HasOne("Unilever.CDExcellent.API.Models.Entities.Article", "Article")
                        .WithMany("Comments")
            ...
            modelBuilder.Entity("Unilever.CDExcellent.API.Models.Entities.UserTask", b =>
                {
                    ...
                    b.HasOne("Unilever.CDExcellent.API.Models.Entities.User", null)
                        .WithMany("UserTasks")
                        .HasForeignKey("UserId");
